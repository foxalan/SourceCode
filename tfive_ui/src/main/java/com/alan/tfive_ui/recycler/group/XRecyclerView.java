...
import static com.alan.tfive_ui.recycler.group.BaseRefreshHeader.STATE_DONE;

/**
 * 自定义可以刷新的RecyclerView
 * 1.重写setAdapter
 */
public class XRecyclerView extends RecyclerView {
    ...
    private static final int TYPE_EMPTY = 10003; //数据为空
